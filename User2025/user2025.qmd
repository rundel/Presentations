...
::: {.aside}
These selectors are built on [`tidyselect`](https://tidyselect.r-lib.org) with multiple selectors being `or`d / unioned together
:::
...
::: {.aside}
Automation (Makefile, targets, etc.) to generate the subsidiary repos is left as an exercise to the audience
:::
