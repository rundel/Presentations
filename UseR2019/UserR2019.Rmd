...
2. Setup git and get a GitHub personal access token (PAT) - [github.com/settings/tokens](https://github.com/settings/tokens)
  - Need help? Read [usethis setup vignetee](https://usethis.r-lib.org/articles/articles/usethis-setup.html) or [happy git with R](https://happygitwithr.com/)
...
## Inviting Students - a few days later ...
...
```{r assignment}
org_create_assignment(org = "ghclass-demo", repo = roster$hw02, 
                      user = roster$github, team = roster$hw02, 
                      source_repo = "Sta323-Sp19/hw2")
```
